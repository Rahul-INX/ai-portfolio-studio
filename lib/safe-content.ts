...
export const safeSiteProfile: SiteProfile = {
  ...
  contactEmail: "rahul.harivansh2001@gmail.com",
  contactPhone: "+91 93158 66406",
  contactLocation: "Chennai, India",
  githubUrl: "https://github.com/Rahul-INX",
  linkedinUrl: "https://www.linkedin.com/in/rahul-harivansh-fatyal/",
  heroEyebrow: "GenAI Developer & Data Science Professional",
  heroTitle: "Building practical AI systems from messy data.",
  heroSummary:
    "Explore RAG, support automation, resume intelligence, and applied machine-learning work through architecture, trade-offs, and public evidence.",
  ...
  modelLabel: "Technical focus",
  modelValue: "GenAI & Machine Learning",
  ...
  awardsTitle: "Evidence supporting the GenAI engineering story.",
  awardsDescription:
    "Awards, credentials, leadership signals, and milestone proof relevant to the work.",
  ...
  timelineDescription:
    "A structured view of education, projects, skills, credentials, and the current technical focus.",
  ...
  ogFooterLabel: "Recruiter-ready navigation"
};
...
export const safeTimeline: TimelineItem[] = [
  ...
  },
  {
    ...
    period: "2026",
    description:
      "Focused on evidence-led AI products, retrieval quality, structured extraction, RBAC-aware tools, and production-minded GenAI workflows.",
    signal: "Trust",
    sortOrder: 4
  },
  {
